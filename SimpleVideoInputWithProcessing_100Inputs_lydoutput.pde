...
boolean first = true;
float minmonka;
//Her har jeg defineret et array "Lyde", som indeholder alle de toner jeg gerne vil afspille.
...
void draw() {
  ...
  //rect(200,200,monkax*height,monkay*height);
}
...
// Jeg har her lavet en integer, som jeg kalder "sinefreq". Den her integer definere jeg som min Oscmessage - 1, da jeg skal smide den ind i mit array og jeg skal bruge startværdien i arrayet "0".
      ...
      //monkay = theOscMessage.get(1).floatValue();
    } else {
